...
import Experience from '../modals/signup/Experience';
import Input from '../modals/signup/Input';
import Interests from '../modals/signup/Interests';
import Skills from '../modals/signup/Skills';
import SocialMedia from '../modals/signup/SocialMedia';
import Location from '../modals/signup/Location';
  ...
  return (
    <Backdrop>
      <div className="w-full h-full bg-white relative flex">
        ...
        <div className="pt-4 px-4 md:px-20 flex-grow overflow-y-auto">
          <div className="py-auto" style={{ color: '#141820' }}>
            <div
