      ...
      <div className="hidden border border-l-2 font-inter lg:block fixed z-20 inset-0 top-[3.8125rem] left -[max(0, calc(50%-45rem))] right-auto w-[16.5rem] pb-10 pl-8 overflow-y-auto ">
        <nav className="lg:text-sm lg:leading-6 -mt-4">
          <div className=" sticky top-0 -ml-0.5 pointer-events-none ">
            ...
            <div className=" bg-white dark:bg-slate-900 relative pointer-events-auto"></div>
          ...
          <ul>
            ...
            >
              <li>
                <a
                  className="group flex items-center hover:text-sky-500 lg:text-sm lg:leading-6 mb-4 font-medium  "
                  href="http://"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div className="mr-4 rounded-md ring-1 ring-slate-900/5 hover:text-sky-500 shadow-sm group-hover:shadow group-hover:ring-slate-900/5 group-hover:shadow-indigo-2 ">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
            ...
            >
              <li>
                <div
                  ...
                  rel="noopener noreferrer"
                >
                  <div className="mr-4 rounded-md ring-1 ring-slate-900/5 shadow-sm group-hover:shadow group-hover:ring-slate-900/10 group-hover:shadow-indigo-2 ">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
            ...
            >
              <li>
                <div className="group flex items-center hover:text-sky-500 lg:text-sm lg:leading-6 mb-4 font-semibold dark:text-sky-400 ">
                  <div className="mr-4 rounded-md ring-1 ring-slate-900/5 shadow-sm group-hover:shadow group-hover:ring-slate-900/10 dark:ring-0 dark:shadow-none dark:group-hover:shadow-none ">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
            ...
            >
              <li>
                <div className="group flex items-center lg:text-sm lg:leading-6 mb-4 font-medium text-slate-700 hover:text-sky-500 ">
                  <div className="mr-4 rounded-md ring-1 ring-slate-900/5 shadow-sm group-hover:shadow group-hover:ring-slate-900/10 group-hover:shadow-indigo-2 ">
                    <svg
                      width="24"
                      height="24"
            ...
            >
              <li>
                <div className="group flex items-center lg:text-sm lg:leading-6 mb-4 font-medium hover:text-sky-500 ">
                  <div className="mr-4 rounded-md ring-1 ring-slate-900/5 shadow-sm group-hover:shadow group-hover:ring-slate-900/10 group-hover:shadow-indigo-2 ">
                    <svg
                      width="24"
                      height="24"
