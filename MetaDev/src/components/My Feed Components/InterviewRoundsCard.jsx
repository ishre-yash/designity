...
const InterviewRoundsCard = ({ roundData }) => {
  const {
    problemDescription,
    date,
    duration,
      ...
      <div className="w-[682px] shadow-md rounded-lg h-fit bg-white border-2 flex-col items-start justify-start ">
        ...
        >
          ...
          <div
            ...
            } cursor-pointer text-slate-400 text-4xl  duration-1000 ease-in-out`}
          >
            <BiChevronDown />
          </div>
          <div
        ...
        {collapsible && (
          <div
            className={` ${
              collapsible
                ? "animate-[bounce_0.75s_ease-in-out_0.5]"
                : "animate-none"
            } p-5  duration-1000 ease-in-out`}
          >
            <div className="w-full border-2 h-fit ">
              <div className="p-4">
                ...
                <p className="text-slate-600 mt-2 font-inter text-[15px] leading-6">
                  {problemDescription}
                </p>
                <p className="text-slate-600 mt-2 font-inter text-[15px] leading-6">
                  Examples:
                </p>
                <p className="text-slate-600 mt-5 font-inter text-[15px] leading-6">
                  Input n = 3
                </p>
                <p className="text-slate-600 mt-1 font-inter text-[15px] leading-6">
                  Output: 3
                </p>
                <p className="text-slate-600 mt-1 font-inter text-[15px] leading-6">
                  Explanation:
...
export default InterviewRoundsCard;
